...
async function create_pull_request(title = '') {
    let module = await import('https://cdn.skypack.dev/@octokit/rest');

    const octokit = new module.Octokit({auth: "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"});
    ...
    // pr_response = octokit.request('POST /repos/Ostrokrzew/karta-postaci/pulls', {
    //     owner: 'Ostrokrzew',
    //     repo: 'karta-postaci',
    //     title: title,
    //     head: 'Ostrokrzew:after-game',
    //     base: 'master'
    // });
